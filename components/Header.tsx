...
//   return (
//     <header className="bg-slate-800 fixed top-0 z-50 w-full border-b border-white">
//       <nav
...
//         <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-slate-900  px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-400">
//           <div className="flex items-center justify-between">
//             <a href="#" className="-m-1.5 p-1.5">
//               <img className="h-8 w-auto" src="/hjbHeader.svg" alt="" />
//             </a>
//             <button
//               type="button"
